...
CONTAINS
  ...
  do k=1, nLinks  
     ...
     call instream_nutrient_processes(tt,TS,no_day,i, rivertemp11(i), L11_rivert_avg10(i), L11_rivert_avg20(i), &
  ...
  subroutine instream_nutrient_processes(tt,TS,no_day,i, rivertemp11, rt_avg10, rt_avg20, benthic_area, depth, &
