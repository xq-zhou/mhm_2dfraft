...
!  use mo_global_variables, only: nLAIclass, nBasins
  ...
  type(rotationType), dimension(:),allocatable, public :: rotation,rotation_upper,rotation_lower  ! rotation infos
  ...
  type(cropType), dimension(:), allocatable, public      :: cropdata,cropdata_upper,cropdata_lower    ! crop managements 
	! -------------------------------------------------------------------
