...
CONTAINS
  ...
  SUBROUTINE mhm_eval(parameterset, runoff, sm_opti, basin_avg_tws, neutrons_opti,nutrient)
    ...
    do ii = 1, nBasins
       ...
       !open(23, file = "Shalfter_Q.txt") 
       open(24, file = "Selke_NO3.txt")
       !open(123, file = "width.txt")
       ...
       do tt = 1, nTimeSteps
          ...
          call mhm(perform_mpr, read_restart, fracSealed_cityArea,                          & ! IN C
             ...
             !for Meisdorf bode in 2010
            ! if ( (iMeteoTS > 3650 ) .and. (iMeteoTS < 4015 ) ) then  
             ! !write(23,*) L1_pre(2917,iMeteoTS),L1_pre(2918,iMeteoTS),L1_pre(2919,iMeteoTS), &
             ! ! L1_pre(2974,iMeteoTS),L1_pre(2975,iMeteoTS),L1_pre(2976,iMeteoTS), &
             ! ! L1_pre(3030,iMeteoTS),L1_pre(3031,iMeteoTS),L1_pre(3032,iMeteoTS), &
             ! ! L1_pet(2917,iMeteo_p5(1)),L1_pet(2918,iMeteo_p5(1)),L1_pet(2918,iMeteo_p5(1)), &
              ! ! L1_pet(2974,iMeteo_p5(1)),L1_pet(2975,iMeteo_p5(1)),L1_pet(2976,iMeteo_p5(1)), &
              ! ! L1_pet(3030,iMeteo_p5(1)),L1_pet(3031,iMeteo_p5(1)),L1_pet(3032,iMeteo_p5(1))
             ! write(23,*)  L1_total_runoff(2917),L1_total_runoff(2918),L1_total_runoff(2919), &
              ! L1_total_runoff(2974),L1_total_runoff(2975),L1_total_runoff(2976), &
              ! L1_total_runoff(3030),L1_total_runoff(3031),L1_total_runoff(3032) 
                          
 
            
         ! calibration gauge runoff component meisID=3086 hausID=2012 wegeID=1689 nienID=1361  
         ! HadID=918 StassID=1974
          ! 2004-2018
          ! if ((tt > 365 ) .and. (tt < 3289)) then
           ! write(23,*) L1_baseflow(3086),L1_fastRunoff(3086),L1_slowRunoff(3086), L1_total_runoff(3086),&
          ! L1_baseflow(2012),L1_fastRunoff(2012),L1_slowRunoff(2012), L1_total_runoff(2012),&
          ! L1_baseflow(1689),L1_fastRunoff(1689),L1_slowRunoff(1689), L1_total_runoff(1689),&
          ! L1_baseflow(1361),L1_fastRunoff(1361),L1_slowRunoff(1361), L1_total_runoff(1361),&
          ! L1_baseflow(918),L1_fastRunoff(918),L1_slowRunoff(918), L1_total_runoff(918),&
          ! L1_baseflow(1974),L1_fastRunoff(1974),L1_slowRunoff(1974), L1_total_runoff(1974)
          ! end if
          ...
          !if ((tt > 365 ) .and. (tt < 3289)) then
           !   write(23,*) L11_qMod(3316), L11_qMod(3335) 
          !end if
          
          
          ! Downstream hydraulic geometry
          ! if ( (tt > 1463 ) .and. (tt < 5841 ) ) then  
           ! write(23,*) tt,L11_qMod(916),L11_qMod(917),L11_qMod(918),L11_qMod(919),L11_qMod(920), &
          ! L11_qMod(962),L11_qMod(963),L11_qMod(964),L11_qMod(966),L11_qMod(967),L11_qMod(972), &
          ! L11_qMod(973),L11_qMod(1012),L11_qMod(1013),L11_qMod(1014),L11_qMod(1025),L11_qMod(1026), &
          ! L11_qMod(1064),L11_qMod(1078),L11_qMod(1079),L11_qMod(1115),L11_qMod(1131),L11_qMod(1174), &
          ! L11_qMod(1175),L11_qMod(1190),L11_qMod(1191),L11_qMod(1236),L11_qMod(1237),L11_qMod(1252), &
          ! L11_qMod(1253),L11_qMod(1254),L11_qMod(1255),L11_qMod(1300),L11_qMod(1317),L11_qMod(1318), &
          ! L11_qMod(1319),L11_qMod(1365),L11_qMod(1366),L11_qMod(1385),L11_qMod(1386),L11_qMod(1429), &
          ! L11_qMod(1430),L11_qMod(1451),L11_qMod(1452),L11_qMod(1495),L11_qMod(1518),L11_qMod(1584), &
          ! L11_qMod(1648),L11_qMod(1711),L11_qMod(1712),L11_qMod(1777),L11_qMod(1843),L11_qMod(1844), &
          ! L11_qMod(1910),L11_qMod(1911),L11_qMod(1912),L11_qMod(1972),L11_qMod(1973),L11_qMod(1974)          
          ! end if 
          ! if ( (tt > 1463 )) then
           ! write(23,*) tt-1463,L11_qMod(23),L11_qMod(26),L11_qMod(42),L11_qMod(98),L11_qMod(117),L11_qMod(202),&
          ! L11_qMod(217),L11_qMod(218),L11_qMod(258),L11_qMod(299),L11_qMod(326),L11_qMod(339),L11_qMod(383),&
          ! L11_qMod(390),L11_qMod(561),L11_qMod(572),L11_qMod(580),L11_qMod(593),L11_qMod(766),L11_qMod(889),&
          ! L11_qMod(968),L11_qMod(979),L11_qMod(987),L11_qMod(1047),L11_qMod(1107),L11_qMod(1244),L11_qMod(1281),&
          ! L11_qMod(1339),L11_qMod(1357),L11_qMod(1376),L11_qMod(1415),L11_qMod(1475),L11_qMod(1620),L11_qMod(1656),&
          ! L11_qMod(1704),L11_qMod(1747),L11_qMod(1690),L11_qMod(1858),L11_qMod(1983),L11_qMod(1988),L11_qMod(2010),&
          ! L11_qMod(2031),L11_qMod(2077),L11_qMod(2131),L11_qMod(2162),L11_qMod(2170),L11_qMod(2180),L11_qMod(2219),&
          ! L11_qMod(2236),L11_qMod(2237),L11_qMod(2240),L11_qMod(2320),L11_qMod(2329),L11_qMod(2342),L11_qMod(2368),&
          ! L11_qMod(2377),L11_qMod(2391),L11_qMod(2434),L11_qMod(2499),L11_qMod(2507),L11_qMod(2515),L11_qMod(2526),&
          ! L11_qMod(2575),L11_qMod(2812),L11_qMod(2831),L11_qMod(2842),L11_qMod(2844),L11_qMod(2852),L11_qMod(2857),&
          ! L11_qMod(2904),L11_qMod(2905),L11_qMod(2906),L11_qMod(2909),L11_qMod(2956),L11_qMod(2968),L11_qMod(2972),&
          ! L11_qMod(2987),L11_qMod(3002),L11_qMod(3009),L11_qMod(3064),L11_qMod(3074),L11_qMod(3105),L11_qMod(3142),&
          ! L11_qMod(3164),L11_qMod(3166),L11_qMod(3188),L11_qMod(3194),L11_qMod(3204),L11_qMod(3214),L11_qMod(3230),&
          ! L11_qMod(3278),L11_qMod(3310),L11_qMod(3319),L11_qMod(3321),L11_qMod(3348),L11_qMod(3351),L11_qMod(3358)
          ! end if
          
          !JS 2015-2018
            ! if ( (iMeteoTS >= 5479 ) .and. (iMeteoTS <= 6940 ) ) then 
            ! write(23,*) L11_qMod(866),L11_qMod(921),L11_qMod(974),L11_qMod(1583),L11_qMod(1387),L11_qMod(1713), &
               ! L11_qMod(1647),L11_qMod(2034)
            ! end if
#endif
        ...
        if (processMatrix(11,1) .eq. 1 ) then
             ...
             !write(22,*) basin_mrm%gaugeIndexList(ii,:),basin_mrm%gaugeNodeList(ii,:), &
             !                WQM_nutrient(tt, basin_mrm%gaugeIndexList(ii,:), 1)
             
         ! calibration gauge Nitrate in runoff component meisID=3086 hausID=2012 wegeID=1689 nienID=1361  
         ! HadID=918 StassID=1974
          ! 2004-2018
          ! if ((tt > 1461 ) .and. (tt < 6941)) then
           ! write(24,*) L1_cbaseflow(3086,1),L1_cfastRunoff(3086,1),L1_cslowRunoff(3086,1), L1_ctotal_runoff(3086,1),&
          ! L1_cbaseflow(2012,1),L1_cfastRunoff(2012,1),L1_cslowRunoff(2012,1), L1_ctotal_runoff(2012,1),&
          ! L1_cbaseflow(1689,1),L1_cfastRunoff(1689,1),L1_cslowRunoff(1689,1), L1_ctotal_runoff(1689,1),&
          ! L1_cbaseflow(1361,1),L1_cfastRunoff(1361,1),L1_cslowRunoff(1361,1), L1_ctotal_runoff(1361,1),&
          ! L1_cbaseflow(918,1),L1_cfastRunoff(918,1),L1_cslowRunoff(918,1), L1_ctotal_runoff(918,1),&
          ! L1_cbaseflow(1974,1),L1_cfastRunoff(1974,1),L1_cslowRunoff(1974,1), L1_ctotal_runoff(1974,1)
          ! end if
             
            !if ((tt > 1 ) .and. (tt < 3289))  then
            ! write(24,*) tt, L11_concMod(3295,1),L11_concMod(3336,1), L11_concMod(3301,1), L11_concMod(3172,1),&
             !  L11_concMod(2799,1), L11_concMod(2416,1), L11_concMod(2216,1)
            ! end if
             !JS 2015-2018
             !if ( (iMeteoTS >= 5479 ) .and. (iMeteoTS <= 6940 ) ) then 
             !  write(24,*) L11_concMod(866,1),L11_concMod(921,1),L11_concMod(974,1),L11_concMod(1583,1),L11_concMod(1387,1),&
              !       L11_concMod(1713,1),L11_concMod(1647,1),L11_concMod(2034,1)
             !end if
